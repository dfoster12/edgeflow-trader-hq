...
import { Search, Bell, Plus, User, TrendingUp } from 'lucide-react';
...
export function AppHeader() {
  ...
  return (
    <header className="sticky top-0 z-40 h-16 flex items-center justify-between px-6 border-b border-border bg-background/80 backdrop-blur-xl">
      {/* Search */}
      ...
      <div className="flex items-center gap-3">
        ...
        {/* Quick Action */}
        <Button size="sm" className="gap-1.5 bg-primary text-primary-foreground hover:bg-primary/90 shadow-lg shadow-primary/20">
        ...
        <div className="relative">
          ...
          {showNotifs && (
            <div className="absolute right-0 top-full mt-2 w-80 rounded-xl border border-border bg-card/95 backdrop-blur-xl shadow-2xl p-2 animate-fade-in">
